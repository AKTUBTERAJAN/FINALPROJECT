...
class myproductAdmin(admin.ModelAdmin):
    ...
    list_display=('id','product_category','subcategory_name','price','discount_price','product_pic','total_discount','product_quantity','pdate')
admin.site.register(myproduct,myproductAdmin)


class registerAdmin(admin.ModelAdmin):
    list_display=('name','email','passwd','profile','address','profile')
